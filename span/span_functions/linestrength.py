...
def ew_measurement(wavelength, flux, index_file, is_usr_idx, want_plot, verbose, calculate_error, save_plot, spec_name, normalize_spec, result_plot_dir):
    ...
    if is_usr_idx == False and normalize_spec == True:
        ...
        for t in range (num_indices):
            ...
            if(want_plot == True or save_plot == True):
...
#9) Calculating the velocity dispersion coefficients to correct the EW due to velocity dispersion broadening
...
#*****************************************************************************************************
#10) Correction EW for the sigma broadening
...
#*****************************************************************************************************
#11) Correction EW for the sigma broadening of Lick/IDS indices
